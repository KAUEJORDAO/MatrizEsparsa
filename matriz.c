...
void insere(Matriz *matriz, int linha, int coluna, float valor)
{
    ...
    {
        printf("Valores da matriz invalido. Linha: %d, Coluna: %d\n", linha, coluna);
...
Matriz somaMatrizes(Matriz A, Matriz B)
{
    ...
    {
        printf("As matrizes tem dimensoes diferentes. Ajuste e tente novamente.\n");
        exit(1);
    }
...
Matriz multiplicaMatrizes(Matriz A, Matriz B)
{
    if (A.ncol != B.nlin)
    {
        printf("Para efetuar o produto de matrizes, o numero de linhas de uma matriz deve condizer com o numero de colunas da outra. Ajuste e tente novamente.\n");
        exit(1);
    }
